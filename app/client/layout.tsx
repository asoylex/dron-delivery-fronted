                    ...
                    <div className="relative flex h-16 justify-between">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                                ...
                                <Link
                                    href="/client"
                                    className={`inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium ${isRoute("/client") ? "border-green-500 text-gray-900" : "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700"
                                        }`}
                                >
                                    Realizar pedido
                                </Link>
                                <Link
                                    href="/client/orders"
                                    className={`inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium ${isRoute("/client/orders") ? "border-green-500 text-gray-900" : "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700"
                                        }`}
                                >
